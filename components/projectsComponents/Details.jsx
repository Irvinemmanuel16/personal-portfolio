...
export default function Details({
  ...
  return (
    <section className='p-6 md:p-12 lg:px-16 relative'>
      ...
      <p className='font-open text-gray text-xl mt-10 md:text-3xl lg:text-4xl lg:font-extrabold font-bold transform md:rotate-90 md:tracking-widest md:flex md:self-center md:absolute md:-right-11 lg:top-40 md:top-26 h-auto'>
        Approach
      </p>
