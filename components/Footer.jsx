...
export default function Footer() {
  return (
    <footer className='px-8 mt-12 md:px-16 lg:px-28 xl:px-28 flex flex-col items-center'>
      ...
      <PersonalLogo />
      <a
        className='font-open text-orange md:text-xl md:py-4'
        href='mailto:irvinemmanuel16@gmail.com'
      >
        irvinemmanuel16@gmail.com
      </a>
      <div className='flex justify-evenly lg:justify-between my-8 w-36 md:w-40 lg:w-44'>
        <a
          target='blank'
          rel='noreferrer'
          href='https://www.linkedin.com/in/irvin-emmanuel-b232b81aa/'
        >
          <LinkedinLogo />
        </a>
        <a
          target='blank'
          rel='noreferrer'
          href='https://www.instagram.com/irvinemmanuel16/'
        >
          <InstagramLogo />
        </a>
        <a
          target='blank'
          rel='noreferrer'
          href='https://github.com/Irvinemmanuel16?tab=repositories'
        >
          <GithubLogo />
        </a>
      </div>
