export default function SobreMi({ reference }) {
  return (
    <section ref={reference} className='mt-14 px-8 md:px-16 xl:px-28 flex flex-col relative'>
      ...
      <div className='mt-6 md:h-auto'>
        ...
        <p className='py-2 text-white font-open md:text-lg md:w-auto'>Soy un estudiante panameño, graduado de bachiller en <br /> ciencias de la informática, apasionado por la innovación y <br /> creatividad en la experiencia del usuario.</p>
      </div>
      ...
      <span className='font-source text-white md:font-bold lg:text-4xl text-right py-5 md:text-2xl'>Paul Rand</span>
    </section>
  )
}