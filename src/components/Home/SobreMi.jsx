  ...
  return (
    <section ref={reference} className='mt-14 px-8 md:px-16 lg:px-28 flex flex-col relative'>
      ...
      <div className='mt-6 md:h-auto'>
        ...
        <p className='py-2 text-white font-open md:py-6 md:w-5/6 lg:text-xl'>I'm a long-term thinking professional with proven experience. Aiming to leverage my skills to innovative and create applications using edge technologies. <br />Specialized in the <span className='font-bold'>MERN</span> stack</p>
      </div>
