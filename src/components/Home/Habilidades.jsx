  ...
  return (
    <section ref={reference} className='mt-6 md:px-16 lg:px-28 px-8 flex flex-col relative'>
      ...
      <div className='mt-8 md:h-auto'>
        <p className='font-open flex text-gray text-xl md:text-3xl lg:text-4xl lg:font-extrabold justify-center font-bold transform md:rotate-90 md:tracking-widest md:self-center md:absolute md:-right-18 md:bottom-24 h-auto'>Habilidades</p>
